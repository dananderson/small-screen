...
export class Gamepad extends InputDevice {
  ...
  constructor (nativeGamepad) {
     ...
     * @type {boolean[]}
     */
    this.buttons = Array(nativeGamepad.getButtonCount() + nativeGamepad.getHatCount() * 4).fill(false)
     ...
     * @type {number[]}
     */
    this.axes = Array(nativeGamepad.getAxisCount()).fill(0)
    ...
    this._hats = Array(nativeGamepad.getHatCount()).fill(0)
  }
