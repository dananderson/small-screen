...
import { SDLGamepad, SDLClient } from './small-screen-sdl'
...
export class SDLWindow {
  constructor (SDL) {
    ...
    this.width = this.caps.defaultResolution.width
    this.height = this.caps.defaultResolution.height
    this.screenWidth = 0
    this.screenHeight = 0
    this.fullscreen = true
    this.vsync = this.caps.vsync
    this.title = ''
    this.textureFormat = this.caps.textureFormat
    this.inputReceiver = {
  ...
  getContext () {
    return this._context._reset(this.client)
  }
