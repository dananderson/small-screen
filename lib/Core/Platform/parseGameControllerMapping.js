...
let HAT_REGEX = /h([\d]+).([1248])/
let SIGNED_AXIS_REGEX = /([+-])a([\d]+)/
let AXIS_REGEX = /a([\d]+)(~)?/

let AXIS_NEGATIVE = Mapping.Axis.NEGATIVE
let AXIS_RANGE = Mapping.Axis.RANGE
let AXIS_POSITIVE = Mapping.Axis.POSITIVE
