...
export class View {
  ...
  updateProps (props) {
    ...
    // TODO: Check if props have actually changed before marking dirty.
    this._app.root._isDirty = true
  }
