...
function getPadding (style, node) {
  return style[HINT_HAS_PADDING] ? [
    node.getComputedPadding(EDGE_TOP),
    node.getComputedPadding(EDGE_RIGHT),
    node.getComputedPadding(EDGE_BOTTOM),
    node.getComputedPadding(EDGE_LEFT)
  ] : ZEROES
}

function getBorder (style, node) {
  return style[HINT_HAS_BORDER] ? [
    node.getComputedBorder(EDGE_TOP),
    node.getComputedBorder(EDGE_RIGHT),
    node.getComputedBorder(EDGE_BOTTOM),
    node.getComputedBorder(EDGE_LEFT)
  ] : ZEROES
}
