...
import { OVERFLOW_HIDDEN, UNIT_PERCENT } from '../Util/Yoga'
...
function blit (ctx, { texture, width, height, aspectRatio, capInsets }, { objectFit, objectPositionX, objectPositionY, rotate }, x, y, boxWidth, boxHeight) {
  ...
  if (rotate instanceof Value) {
    rotate = rotate.getValue()
  }

  ctx.blit(texture, capInsets, rotate, boxWidth / 2, boxHeight / 2, x + dx, y + dy, fitWidth, fitHeight)
}
