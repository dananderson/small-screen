...
let styleMap = new Map([ ['normal', FONT_STYLE_NORMAL], ['italic', FONT_STYLE_ITALIC] ])
let validStyles = new Set([FONT_STYLE_NORMAL, FONT_STYLE_ITALIC])
let weightMap = new Map([ ['normal', FONT_WEIGHT_NORMAL], ['bold', FONT_WEIGHT_BOLD] ])
let validWeights = new Set([FONT_WEIGHT_NORMAL, FONT_WEIGHT_BOLD])
