...
export const COMPUTED_LAYOUT_TOP = 0
export const COMPUTED_LAYOUT_RIGHT = 1
export const COMPUTED_LAYOUT_BOTTOM = 2
export const COMPUTED_LAYOUT_LEFT = 3
export const COMPUTED_LAYOUT_WIDTH = 4
export const COMPUTED_LAYOUT_HEIGHT = 5

export const COMPUTED_BORDER_TOP = 6
export const COMPUTED_BORDER_RIGHT = 7
export const COMPUTED_BORDER_BOTTOM = 8
export const COMPUTED_BORDER_LEFT = 9

export const COMPUTED_PADDING_TOP = 10
export const COMPUTED_PADDING_RIGHT = 11
export const COMPUTED_PADDING_BOTTOM = 12
export const COMPUTED_PADDING_LEFT = 13

export const COMPUTED_MARGIN_TOP = 14
export const COMPUTED_MARGIN_RIGHT = 15
export const COMPUTED_MARGIN_BOTTOM = 16
export const COMPUTED_MARGIN_LEFT = 17
