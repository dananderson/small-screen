...
import { joinThreadPool } from '../Core/Util/small-screen-lib'
...
export function init () {
  ...
  const { hasGraphics, hasGamepad, hasAudio } = platform.capabilities

  console.log('Graphics available: %j', !!hasGraphics)
  console.log('Gamepad available: %j', !!hasGamepad)
  console.log('Audio available: %j', !!hasAudio)
